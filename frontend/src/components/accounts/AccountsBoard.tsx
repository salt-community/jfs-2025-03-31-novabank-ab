...
export function AccountsBoard({ bankAccounts }: AccountsBoardProps) {
  ...
  return (
    <div className="px-4 sm:px-8 py-6 space-y-12" data-testid="accounts-board">
      <h1 className="text-3xl mb-8 sm:mb-15">{t('myBankAccounts')}</h1>
      <div className="space-y-3">
        ...
        <button
          className="mt-5 flex align-center items-center justify-between hover:cursor-pointer w-full py-2 px-3 bg-[#FFB20F] hover:bg-[#F5A700] text-black shadow-md rounded-lg transition-colors"
